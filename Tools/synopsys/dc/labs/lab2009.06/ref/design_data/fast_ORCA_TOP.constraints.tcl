#same as normal constraints file, except clock periods are slower by an order of magnitude -- that is, I added a zero to each period
...
set max_opcon cb13fs120_tsmc_max


# PCI clock at 66 MHz
create_clock -period 150.0 -name PCI_CLK [get_ports pclk]
# System clock at 125 MHz
create_clock -period 80.0 -name SYS_CLK [get_ports sys_clk]
# System clock at 250 MHz
create_clock -period 40.0 -name SYS_2x_CLK [get_ports sys_2x_clk]
# SDRAM clock at 133 MHz
create_clock -period 70.5 -name SDRAM_CLK [get_ports sdram_clk]
