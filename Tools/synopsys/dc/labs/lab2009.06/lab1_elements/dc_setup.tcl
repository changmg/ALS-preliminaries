...
#
#       IC Compiler ILMs must be included in ${MW_REFERENCE_LIB_DIRS} and require a
#       Milkyway library setup even if you are using DC in WLM (non-topographical) mode.
##########################################################################################

set DDC_HIER_DESIGNS             "SDRAM_TOP RISC_CORE PCI_TOP"  ;# List of Design Compiler hierarchical design names (DDC will be read)
