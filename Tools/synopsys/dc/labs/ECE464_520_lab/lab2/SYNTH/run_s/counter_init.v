...
module counter ( clock, in, latch, dec, zero );
  ...
  DFF_X1 \value_reg[0]  ( .D(n2), .CK(clock), .Q(value[0]), .QN(n23) );
  DFF_X1 \value_reg[1]  ( .D(n20), .CK(clock), .Q(value[1]) );
  DFF_X1 \value_reg[2]  ( .D(n3), .CK(clock), .Q(value[2]), .QN(n24) );
  DFF_X1 \value_reg[3]  ( .D(n21), .CK(clock), .Q(value[3]) );
